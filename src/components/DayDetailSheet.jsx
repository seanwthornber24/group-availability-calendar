...
export default function DayDetailSheet({ date, participants, availability, currentParticipantId, onToggle, onClose }) {
  if (!date) { return null }
  ...
  const iAmFree = freeParticipantIds.has(currentParticipantId)
