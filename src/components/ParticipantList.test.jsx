...
const AVAILABILITY = [
  ...
  { participant_id: 'p1', date: '2026-04-02' },
  { participant_id: 'p1', date: '2026-04-03' },
...
describe('ParticipantList', () => {
  ...
  it('renders the current participant first', () => {
    ...
    const items = screen.getAllByText(/(Alice|Bob|Carol)/).filter(
      (el) => !el.closest('[class*="text-xs"]') // exclude avatar letters and "(you)" elements
    )
    // Bob should appear first since they're the current user
